...
<html lang="pt-BR">
	<head>
		...
		<meta name="description" content="Animes > Todas as categorias > Ação">
		...
		<!-- Page title -->
		<?php $page_title = "Animes - Todas as categorias - Ação | Izumi✰Project"; ?>
    ...
    <div id="content">
      <div id="post-wrapper" style="width: 98.5%; margin-right: 0;">
        <div class="post" style="padding: 1em;">
					<h1>Animes > Todas as categorias > Ação</h1>
  ...
  <form>
      ...
      <option value="2" selected>Ação</option>
      ...
      <script type="text/javascript" src="../../../../scripts/top-button.js"></script>
			...
			<script>
				...
				function generoF() {
					...
					if (gen === "2") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/acao") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/tv
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/acao");
						}
					}
					if (gen === "3") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/aventura") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/ova
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/aventura");
						}
					}
					if (gen === "4") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/slice-of-life") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/ona
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/slice-of-life");
						}
					}
					if (gen === "5") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/comedia") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/filme
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/comedia");
						}
					}
					if (gen === "6") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/romance") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/filme
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/romance");
						}
					}
					if (gen === "7") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/drama") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/filme
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/drama");
						}
					}
					if (gen === "8") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/fantasia") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/filme
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/fantasia");
						}
					}
					if (gen === "9") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/ficcao-cientifica") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/filme
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/ficcao-cientifica");
						}
					}
					if (gen === "10") {
						if (window.location.href === "https://izumiproject.com.br/projetos/animes/genero/escola") {
							 // Não fazer nada!
						}
						else {
							// Ir para /categoria/filme
							window.location.href = ("https://izumiproject.com.br/projetos/animes/genero/escola");
						}
					}
				}
			</script>
