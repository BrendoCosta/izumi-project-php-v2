...
<html lang="pt-BR">
	<head>
		...
		<meta name="description" content="Animes - TV - Escola">
		...
		<!-- Page title -->
		<?php $page_title = "Animes - TV - Escola | Izumi✰Project"; ?>
  ...
  <form>
      ...
      <option value="9">Ficção científica</option>
       <option value="10" selected>Escola</option>
    </select>
  </form>
					<br />
				<h2>Todos</h2>
