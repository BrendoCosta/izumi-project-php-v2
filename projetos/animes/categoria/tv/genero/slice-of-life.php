...
<html lang="pt-BR">
	<head>
		...
		<meta name="description" content="Animes - TV - Slice-of-life">
		...
		<!-- Page title -->
		<?php $page_title = "Animes - TV - Slice-of-life | Izumi✰Project"; ?>
  ...
  <form>
      ...
      <option value="4" selected>Slice-of-life</option>
      ...
      <option value="9">Ficção científica</option>
       <option value="10">Escola</option>
				...
				<ol id='list' class="ol-row">
					...
					<?php include('../../../../../cards-projetos/kin-iro-mosaic/card.php'); ?>
					<?php include('../../../../../cards-projetos/mitsuboshi-colors/card.php'); ?>
					<?php include('../../../../../cards-projetos/miyakawa-ke-no-kuufuku/card.php'); ?>
					<?php include('../../../../../cards-projetos/nekopara/card.php'); ?>
					</ol>
        </div>
      </div>
