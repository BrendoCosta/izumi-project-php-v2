...
<html lang="pt-BR">
	<head>
		...
		<meta name="description" content="Animes - TV - Romance">
		...
		<!-- Page title -->
		<?php $page_title = "Animes - TV - Romance | Izumi✰Project"; ?>
  ...
  <form>
      ...
      <option value="6" selected>Romance</option>
