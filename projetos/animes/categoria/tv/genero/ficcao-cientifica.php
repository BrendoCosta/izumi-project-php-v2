...
<html lang="pt-BR">
	<head>
		...
		<meta name="description" content="Animes - TV - Ficção científica">
		...
		<!-- Page title -->
		<?php $page_title = "Animes - TV - Ficção científica | Izumi✰Project"; ?>
    ...
    <div id="content">
      <div id="post-wrapper" style="width: 98.5%; margin-right: 0;">
        <div class="post" style="padding: 1em;">
					<h1>Animes > TV > Ficção científica</h1>
  ...
  <form>
      ...
      <option value="9" selected>Ficção científica</option>
